                    ...
                    <form id="contact" action="" method="post">
                        <div class="row">
                          <div class="col-lg-12 mb-3">
                            <fieldset>
                              <input name="email" type="text" id="email" placeholder="Your Name" required="">
                            </fieldset>
                          </div>
                          <div class="col-lg-12 mb-3">
                            <fieldset>
                          ...
                          <div class="col-lg-12">
                            <fieldset>
                              <button type="submit" class="btn btn-dark">Signup Here</button>
							  <a href="login.php" class="float-end">If you already Registered then Login Here</a>
							</fieldset>
						  </div>
                        </div>
                      </form>
